...
submitButton.addEventListener("click", (e) => {
    ...
    if (isPublisher == true) {
        ...
        fetch('http://127.0.0.1:8080/ChapterX-1.0-SNAPSHOT/webresources/User/publisherRegistration', {
            method: 'POST',
            headers: {
        ...
        fetch('http://localhost:8080/webresourses/User/generalRegistration', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
